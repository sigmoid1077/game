...
use crate::{server::event, SendingPacket, RecievingPacket};

#[derive(SystemParam)]
pub struct ServerSystemParam<'w, 's, Sp: SendingPacket, Rp: RecievingPacket> {
...
impl<'w, 's, Sp: SendingPacket, Rp: RecievingPacket> ServerSystemParam<'w, 's, Sp, Rp> {
